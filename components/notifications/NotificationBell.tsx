...
export default function NotificationBell({ userId, initialNotifications = [] }: NotificationBellProps) {
  ...
  return (
    <div className="relative" ref={dropdownRef}>
      ...
      {/* Dropdown */}
      {isOpen && (
        <div className="absolute right-0 mt-2 w-96 max-w-[calc(100vw-2rem)] bg-surface-50 rounded-2xl border border-surface-200 shadow-elevation-3 z-50 overflow-hidden">
          {/* Header */}
