...
| `theme_id` | text | Theme preset identifier |
| `theme_overrides` | jsonb | Theme overrides (colors) |
| `typography_id` | text | Typography preset identifier |
| `density_id` | text | Density preset identifier |
| `radius_id` | text | Radius preset identifier |
| `motion_id` | text | Motion preset identifier |
